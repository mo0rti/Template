...
1. **Always read `SCHEMA.md` first** before performing any wiki operation.

2. **Always read `index.md`** before creating a new page to check whether it already exists.
...
5. **Always update `index.md` and append to `log.md`** after any write operation.
...
8. **Before running `/board-review`**, always read `advisory/BOARD.md` in full.
